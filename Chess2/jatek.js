    ...
    constructor(type,x,y) {
        ...
        switch(type) {
            ...
            case 1:
                ...
                this.stepphase = 0
                this.update = function() {
                    if ( this.stepphase == 0 && this.stepping == 0) {this.step(pathTo(player.y,player.x,this.x,this.y))}
                    if (this.stepphase == 1 && this.stepping == Math.round(this.steptime / 2)) {console.log("ZOINKS")}
                    if (this.stepping == 1) {this.stepFinish()}
                    if (this.stepping != 0) {this.stepping -= 1}
                }
        }
