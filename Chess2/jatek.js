            ...
            case 0:
                ...
                this.draw = function() {
                    ...
                    if (this.attacking > 0) {
                        ...
                        if (this.facing < 2) {
                            if (this.attacking/this.attackTime > 0.5) {drawRect(260+(this.facing*2-1)*(((this.attackTime-this.attacking)/(this.attackTime*0.5))**5)*-75+this.x*120-this.y*40,75+this.y*50,(((this.attackTime-this.attacking)/(this.attackTime*0.5))**5)*150,40,"grey")}
                            else if (this.attacking/this.attackTime < 0.25) {drawRect(260+(this.facing*2-1)*((this.attacking)/(this.attackTime*0.25))*-75+this.x*120-this.y*40,75+this.y*50,((this.attacking)/(this.attackTime*0.25))*150,40,"grey")}
                            else {drawRect(260+(this.facing*2-1)*-75+this.x*120-this.y*40,75+this.y*50,150,40,"grey")}
                        }
                        if (this.facing == 2) {
